      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {visible.map((p) => (
          <Link
            key={p.href}
            href={p.href}
            className="group flex h-full flex-col cursor-pointer rounded-2xl bg-white p-3 border border-black/[0.06] shadow-[0_8px_20px_-14px_rgba(234,88,12,0.18)] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-1.5 hover:shadow-[0_26px_50px_-16px_rgba(234,88,12,0.45)] motion-reduce:transition-none motion-reduce:hover:translate-y-0"
          >
